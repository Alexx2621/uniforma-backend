...
export const PERMISSION_CATALOG: PermissionDefinition[] = [
  ...
  { key: 'inventario.kardex.view', label: 'Kardex inventario', description: 'Ver movimientos Kardex de inventario', category: 'Inventario' },
  { key: 'inventario.minimos.view', label: 'Alertas de minimos', description: 'Ver alertas de stock minimo por bodega', category: 'Inventario' },
  { key: 'inventario.minimos.manage', label: 'Gestionar minimos', description: 'Crear y modificar stock minimo por producto y bodega', category: 'Inventario' },
